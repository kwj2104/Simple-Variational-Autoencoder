...
#        if self.mcounter == 15:
#            #print(self.e_W0.T[0])
#            sample = np.load('pt_sample.npy')
#            print(sample - grad_e_b0)
#            print(np.max(sample - grad_e_b0))
#            print(sample[30], grad_e_b0[0][30])
#            raise Exception()
...
#                out = np.round(out, decimals=40)
#                mu = np.round(mu, decimals=40)
#                logvar = np.round(logvar, decimals=40)
...
#                    #print(self.e_W0.T[0])
##                    sample = np.load('pt_sample.npy')
##                    print(sample - self.d_W1.T[0])
##                    print(np.max(sample - self.d_W1.T[0]))
#                    raise Exception()
                counter += 1
            ...
            img_tile(np.array(self.img), self.img_path, counter, idx, "res", True)
